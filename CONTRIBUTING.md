Contributing to Efin Core
============================

The Efin project operates an open contributor model where anyone is
...
Most communication about Efin development happens on [#efin-dev:matrix.org](https://riot.im/app/#/room/#efin-dev:matrix.org), in the Efin Open Development channel on Riot. The easiest way to participate on Riot is
...
The following applies to code changes to the Efin project..

Whether a pull request is merged into Efin Core rests with the project merge
...
Patches that change Efin consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the Efin consensus, it must have been
...
The project leader is the release manager for each Efin Core release.
