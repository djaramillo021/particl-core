...
#ifndef EFIN_SCRIPT_EFINCONSENSUS_H
#define EFIN_SCRIPT_EFINCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBEFINCONSENSUS)
...
#endif // EFIN_SCRIPT_EFINCONSENSUS_H
