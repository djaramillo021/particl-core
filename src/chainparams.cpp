...
static CBlock CreateGenesisBlockTestNet(uint32_t nTime, uint32_t nNonce, uint32_t nBits)
{
    ...
    // Reserved Efin for primary round
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("mainnet-seed.efin.io");
        vSeeds.emplace_back("dnsseed-mainnet.efin.io");
        vSeeds.emplace_back("mainnet.efin.io");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.efin.io");
        vSeeds.emplace_back("dnsseed-testnet.efin.io");
