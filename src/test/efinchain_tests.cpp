...
BOOST_FIXTURE_TEST_SUITE(efinchain_tests, EfinBasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(mixed_input_types)
{
    ...
    txnPrev.nVersion = EFIN_TXN_VERSION;
    BOOST_CHECK(txnPrev.IsEfinVersion());
